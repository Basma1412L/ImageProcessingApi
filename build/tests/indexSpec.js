...
describe('New image is created', function () {
    it('checks  new image', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fs, path, filePath, resolvedCreatedPath, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('fs')); })];
                case 1:
                    fs = _a.sent();
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('path')); })];
                case 2:
                    path = _a.sent();
                    filePath = 'assets/thumb/palmtunnel.jpeg';
                    resolvedCreatedPath = path.resolve(filePath);
                    if (fs.existsSync(resolvedCreatedPath)) {
                        fs_1.promises.unlink(resolvedCreatedPath);
                    }
                    response = request
                        .get('/api/images?filename=palmtunnel&width=200&height=200')

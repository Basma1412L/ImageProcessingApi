...
var fs_1 = require('fs');
var imageScaleFunction_1 = __importDefault(
  require('../utilities/imageScaleFunction')
);
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                (0, imageScaleFunction_1.default)(
                  500,
                  500,
                  filePath,
                  filePath2
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              request.get('/api/images?filename=fjord&width=1000&height=500'),
            ];
          case 1:
            response = _a.sent();
        ...
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              request.get(
                '/api/images?filename=palmtunnel&width=1000&height=500'
              ),
            ];
          case 1:
            response = _a.sent();
